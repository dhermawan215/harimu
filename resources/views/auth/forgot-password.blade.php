...
<head>
    ...
    <title>Lupa Kata Sandi — {{ config('app.name', 'Harimu') }}</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="auth-card bg-white p-4 p-md-5">
                        <h3 class="fw-bold text-center mb-1">Lupa Kata Sandi?</h3>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <button type="submit" class="btn btn-brand btn-lg w-100 rounded-pill">Kirim Tautan Atur Ulang</button>
                        </form>
